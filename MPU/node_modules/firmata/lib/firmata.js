...
function Board(port, options, callback) {
  ...
  this.transport.on("data", function(data) {
    ...
    //console.log("[WWK][553] data.length:" + data.length);  ///< Konrad add for debug
     
    for (var i = 0; i < data.length; i++) {
      byte = data[i];
      //console.log("[WWK][557] recv data:" + byte);
      // we dont want to push 0 as the first byte on our buffer
      if (this.currentBuffer.length === 0 && byte === 0) {      
      	//console.log("[WWK][561] continue");
        continue;
      } else {
        ...
        //console.log("[WWK][561] first:" + first + " last:" + last);  ///< Konrad add for debug
        //console.dir(this.currentBuffer);  
        // [START_SYSEX, ... END_SYSEX]
        if (first === START_SYSEX && last === END_SYSEX) {
          
          //console.log("[WWK] New package come in");  ///< Konrad add for debug
          ...
          if (currByte > 0x7F) {
          	//console.log("[WWK][612] "); 
            //this.currentBuffer.length = 0; ///< Konrad mark
            //this.currentBuffer.push(currByte); ///< Konrad mark
          }
